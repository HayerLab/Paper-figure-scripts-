...
imwrite(chan3_AV,[bgdir,filesep,'AVG_rawdata_',chan2,'.tif'],'TIFF','Compression','None');
% 
%% Determine image alignment between chan1 and chan2 using Sean's method
